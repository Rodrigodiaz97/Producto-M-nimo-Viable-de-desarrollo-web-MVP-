...
<html lang="en">
  <head>
    ...
    <title>PLATAFORMA INMOBILIARIA</title>
  </head>
  <body>
      <div class="d-flex">
          <div id="sidebar-container" class="bg-primary">
              ...
              <div class="menu">
                ...
                <a href="#" class="d-block text-light p-3 text-decoration-none"><i class="icon ion-md-cash m-2 lead text-decoration-none"></i>Rendimientos</a>
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-lg-12 my-3">
                      <div class="card rounded-0">
                        <div class="card-header bg-light">
                          <h6 class="font-weight-bold mb-0">Tus ventas mensuales</h6>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="col-lg-12 my-3">
                      <div class="card rounded-0">
                        <div class="card-header bg-light">
                          <h6 class="font-weight-bold mb-0">Tus ventas anuales</h6>
                        </div>
                        <div class="card-body">
...
var chart = new Chart(ctx, {
    ...
    data:{
	datasets: [{
		data: [30,60,55, 58, 67, 33, 60, 80],
		backgroundColor: ['#42a5f5', 'red', 'green','blue','purple','orange','teal','sienna'],
        borderColor: 'rgb(75, 192, 192)',
        tension: 0.1,
		label: 'Ventas por año (Historico)'}],
