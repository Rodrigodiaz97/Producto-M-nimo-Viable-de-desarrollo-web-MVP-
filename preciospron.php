      ...
      <div class="d-flex">
          <div id="sidebar-container" class="bg-primary">
              ...
              <div class="menu">
                ...
                <a href="#" class="d-block text-light p-3 text-decoration-none"><i class="icon ion-md-stats m-2 lead text-decoration-none"></i>Predicción</a>
                    ...
                    <div class="col-lg-12 my-3">
                      <div class="card rounded-0">
                        <div class="card-header bg-light">
                          <h6 class="font-weight-bold mb-0">Predictores con mayor ponderación en la Regresión Lineal</h6>
                        </div>
                        <div class="card-body">
                          <img src="peso.png" alt="">
                        </div>
                      </div>
                    </div>
                    <!-- 1era barra-->
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-lg-12 my-3">
                      <div class="card rounded-0">
                        <div class="card-header bg-light">
                          <h6 class="font-weight-bold mb-0">Caracteristicas de las variables independientes</h6>
                        </div>
                        <div class="card-body">
                          <img src="numeri.png" alt="">
                        </div>
                      </div>
                    </div>
                    <!-- 1era barra-->
